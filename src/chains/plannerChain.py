...
multiple learning goals from the provided text. Make sure your learning goals are specific, measurable, achievable, relevant, and time-bound (SMART). 
Respond with a comma-separated list of learning goals.
...
class PlannerChain(BaseChain):
    def __init__(self):
        ...
        self.components = {
                ...
                "splitter":  RecursiveCharacterTextSplitterComponent()
        }
