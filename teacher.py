...
if st.sidebar.button("Select"):
    ...
    st.session_state["teacherChain"] = TeacherChain(contents=database_content["results"], user_preferences=st.session_state["learning_preferences"])
    st.session_state["teacherChain"].build()

    # TODO: Add a starting message
